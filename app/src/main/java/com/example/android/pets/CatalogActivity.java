...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            displayView.setText(String.format(Locale.US, "The pets table contains %d pets.\n\n", cursor.getCount()));
            displayView.append(String.format(Locale.US, "%s - %s - %s - %s - %s\n",
            ...
            while (cursor.moveToNext()) {
                ...
                displayView.append((String.format(Locale.US, "\n%d - %s - %s - %d - %d",
